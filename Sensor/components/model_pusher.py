...
""" To make a pkl file we need the below functions """
from Sensor.utils.main_utils import save_object, load_object, write_yaml_file

""" It is used to copy the path from one place to other """
import shutil
...
class ModelPusher:
    ...
    def initiate_model_pusher(self, ) -> ModelPusherArtifact:
        try:
            ...
            """copies the path trained_model_path inside the model_file_path folder
                This file path is fed to next stage if any 
            """
            ...
            """ This is a backup file same as above but stored as backup"""
